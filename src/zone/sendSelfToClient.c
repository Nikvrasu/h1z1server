...
sendSelf.payload_self = (struct payload_self_s[1]){
        [0] = {
            ...
            .current_profile = KOTK_CHARACTER_PROFILE_ID,
            .unk_list_count = 0,
            .collections_count = 0,
            // Inventory
            .items1_count = 6,
            ...
            .equipment_slots = (struct equipment_slots_s[7]){
                ...
                [4] = { .unk_dword_7199=10,  .unk_dword_890=10,  .unk_string_4=hoodieModel,             .unk_string_2=STR8("Default"), .equipment_slot_id2=10,  .equipment_slot_id3=10,  .guid=0x1005,          .tint_alias=STR8("Default"), .decal_alias=STR8("#") },
                [5] = { .unk_dword_7199=14,  .unk_dword_890=14,  .unk_string_4=pantsModel,              .unk_string_2=STR8("Default"), .equipment_slot_id2=14,  .equipment_slot_id3=14,  .guid=0x1006,          .tint_alias=STR8("Default"), .decal_alias=STR8("#") },
                [6] = { .unk_dword_7199=13,  .unk_dword_890=13,  .unk_string_4=shoesModel,              .unk_string_2=STR8("Default"), .equipment_slot_id2=13,  .equipment_slot_id3=13,  .guid=0x1007,          .tint_alias=STR8("Default"), .decal_alias=STR8("#") },
            },
            ...
            .skills_count = 0,
            .containers_count = 6,
            .containers = (struct containers_s[6]){
                [0] = {
                    .loadout_slot_id = 10,
                    .guid = 0x1005,
                    .def_id = 5747,
                ...
                [3] = {
                    ...
                    .items2 = (struct items2_s[1]){
                        [0] = {
                            .item_def_id5 = WEAPON_FISTS,
                            .item_def_id6 = WEAPON_FISTS,
                            .tint_id = 0,
                            .guid = ITEM_GUID_FISTS,
                            .count = 1,
                            .unk_qword_43 = 0,
                ...
                [4] = {
                    ...
                    .guid = ITEM_GUID_BINOCULARS,
                    .def_id = WEAPON_BINOCULARS,
                    .associated_character_id = session->characterId,
                    .slots = 1,
                    .items2_count = 1,
                    .items2 = (struct items2_s[1]){
                        [0] = {
                            .item_def_id5 = WEAPON_BINOCULARS,
                            .item_def_id6 = WEAPON_BINOCULARS,
                            .tint_id = 0,
                            .guid = ITEM_GUID_BINOCULARS,
                            .count = 1,
                            .unk_qword_43 = 0,
                ...
                [5] = {
                    ...
                    .guid = ITEM_GUID_EYES_ATTACHMENT,
                    .def_id = ITEM_DEF_EYES_ATTACHMENT,
                    .associated_character_id = session->characterId,
                    .slots = 1,
                    .items2_count = 1,
                    .items2 = (struct items2_s[1]){
                        [0] = {
                            .item_def_id5 = ITEM_DEF_EYES_ATTACHMENT,
                            .item_def_id6 = ITEM_DEF_EYES_ATTACHMENT,
                            .tint_id = 0,
                            .guid = ITEM_GUID_EYES_ATTACHMENT,
                            .count = 1,
                            .unk_qword_43 = 0,
