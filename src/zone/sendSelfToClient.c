...
sendSelf.payload_self = (struct payload_self_s[1]){
        [0] = {
            ...
            //         .tint_id            = 0,
            //         .guid               = 3457738471903334713,
            //         .count              = 1,
            //         .unk_qword_21       = 0,
            //         .unk_dword_53       = 0,
            //         .unk_dword_24       = 0,
            //         .container_guid     = 0, // Must be non-zero and unique, but the actual value doesn't seem to matter as long as it's consistent with the loadout slot's container_guid
            //         .container_def_id   = 1,
            //         .container_slot_id  = LOADOUT_SLOT_MELEE,
            //         .base_durability    = 0,
            ...
            //         .tint_id            = 0,
            //         .guid               = 3457738471903334710ull, // Must be non-zero and unique, but the actual value doesn't seem to matter as long as it's consistent with the loadout slot's guid
            //         .count              = 1,
            //         .unk_qword_21       = 0,
            //         .unk_dword_53       = 0,
            //         .unk_dword_24       = 0,
            ...
            //         .item_def_id1       = 85,     // WEAPON_FISTS
            //         .tint_id            = 0,
            //         .guid               = 3457738471903334713, // Must be non-zero and unique, but the actual value doesn't seem to matter as long as it's consistent with the loadout slot's guid
            //         .count              = 1,
            //         .unk_qword_21       = 0,
            //         .unk_dword_53       = 0,
            //         .unk_dword_24       = 0,
            //         .container_guid     = 0, // Must be non-zero and unique, but the actual value doesn't seem to matter as long as it's consistent with the loadout slot's container_guid
            //         .container_def_id   = 1,
            //         .container_slot_id  = LOADOUT_SLOT_PRIMARY,
            //         .base_durability    = 0,
            //         .current_durability = 0,
            //         .max_durability_from_def = 0,
            //         .unk_bool_13        = FALSE,
            ...
            .loadout_slots_array = (struct loadout_slots_array_s[2]){
                ...
                [1] = {
                    .hotbar_slot_id    = 1542,   // WEAPON_BINOCULARS
                    .loadout_id        = LOADOUT_ID_KOTK_CHARACTER,
                    .slot_id           = 5,      // Binoculars slot
                    .item_def_id4      = WEAPON_BINOCULARS,
                    .loadout_item_guid = 3457738471903334710,
                    .unk_byte_17       = 1,
                    .unk_dword_111     = 22,
                },
            },
            .current_slot_id = 5, // Binoculars
