...
void SendSelfToClient(AppState* app, SessionState* session, int withStats) {
    ...
    [0] = {
        ...
        .equipment_slots_count = 8,
        .equipment_slots = (struct equipment_slots_s[8]){
            [0] = { .unk_dword_7199=1,   .unk_dword_890=1,   .unk_string_4=STR8("Default"), .unk_string_2=STR8("#"), .equipment_slot_id2=1,   .equipment_slot_id3=1,   .guid=0,               .tint_alias=STR8("Default"), .decal_alias=STR8("#") },
            [1] = { .unk_dword_7199=3,   .unk_dword_890=3,   .unk_string_4=STR8("Default"), .unk_string_2=STR8("#"), .equipment_slot_id2=3,   .equipment_slot_id3=3,   .guid=0x1001,          .tint_alias=STR8("Default"), .decal_alias=STR8("#") },
            [2] = { .unk_dword_7199=4,   .unk_dword_890=4,   .unk_string_4=STR8("Default"), .unk_string_2=STR8("#"), .equipment_slot_id2=4,   .equipment_slot_id3=4,   .guid=0x1002,          .tint_alias=STR8("Default"), .decal_alias=STR8("#") },
            [3] = { .unk_dword_7199=7,   .unk_dword_890=7,   .unk_string_4=STR8("Default"), .unk_string_2=STR8("#"), .equipment_slot_id2=7,   .equipment_slot_id3=7,   .guid=ITEM_GUID_FISTS, .tint_alias=STR8("Default"), .decal_alias=STR8("#") },
            [4] = { .unk_dword_7199=105, .unk_dword_890=105, .unk_string_4=STR8("Default"), .unk_string_2=STR8("#"), .equipment_slot_id2=105, .equipment_slot_id3=105, .guid=0x1004,          .tint_alias=STR8("Default"), .decal_alias=STR8("#") },
            [5] = { .unk_dword_7199=10,  .unk_dword_890=10,  .unk_string_4=STR8("Default"), .unk_string_2=STR8("#"), .equipment_slot_id2=10,  .equipment_slot_id3=10,  .guid=0x1005,          .tint_alias=STR8("Default"), .decal_alias=STR8("#") },
            [6] = { .unk_dword_7199=14,  .unk_dword_890=14,  .unk_string_4=STR8("Default"), .unk_string_2=STR8("#"), .equipment_slot_id2=14,  .equipment_slot_id3=14,  .guid=0x1006,          .tint_alias=STR8("Default"), .decal_alias=STR8("#") },
            [7] = { .unk_dword_7199=13,  .unk_dword_890=13,  .unk_string_4=STR8("Default"), .unk_string_2=STR8("#"), .equipment_slot_id2=13,  .equipment_slot_id3=13,  .guid=0x1007,          .tint_alias=STR8("Default"), .decal_alias=STR8("#") },
        },
        ...
        .loadout_slots_array_count = 3,
        .loadout_slots_array = (struct loadout_slots_array_s[3]){
            [0] = {
            ...
            [2] = {
                .hotbar_slot_id    = LOADOUT_SLOT_PRIMARY,
                .loadout_id        = LOADOUT_ID_KOTK_CHARACTER,
                .slot_id           = LOADOUT_SLOT_PRIMARY,
                .item_def_id4      = WEAPON_FISTS,
                .loadout_item_guid = ITEM_GUID_FISTS,
            },
        },
